...
# Source: skills/pre-trade-discipline-gate/scripts/check_pre_trade_discipline.py
# https://github.com/tradermonty/claude-trading-skills
# Copyright (c) 2026 TraderMonty. See unmassk-trading/CREDITS.md.
# Adaptations for EUR / 24-7 crypto are tracked separately and are NOT in this commit.
"""
...
def _load_thesis_store_module():
    module_path = (
        Path(__file__).resolve().parent / "thesis_store.py"
    )
