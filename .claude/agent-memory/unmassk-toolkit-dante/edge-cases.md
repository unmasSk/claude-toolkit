...
## release.py — Edge Cases — MOVED 2026-08-25

Relocated verbatim to [release-py-contract-notes.md](release-py-contract-notes.md) — this content targets
`bin/release.py`/`bump-version.py`, both still live and in use, unlike the rest of this file. Nothing was
cut, only moved to a linkable home; see that file for the full section (semver ordering, CHANGELOG format,
date-rollover technique, --dry-run guarantees, bump-version.py retrocompat).
