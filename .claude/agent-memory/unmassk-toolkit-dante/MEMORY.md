...
- [note-exact-key-zone-duplicate-gate-contract-notes.md](note-exact-key-zone-duplicate-gate-contract-notes.md) — same-keys+same-zone exact-match gate RED; empty-keys guard; +BREAK 2 zone-pair-as-set RED
