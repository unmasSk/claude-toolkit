...
- [issue-57-round2e-fence-invariant-contract-notes.md](issue-57-round2e-fence-invariant-contract-notes.md) — issue #57 round 2e (decision e861680, memo b49eb60): structural/invariant fence-shape regex (`<\s*/?\s*memory-data\s*>`) replacing byte-enumeration — catches whole sanitizer byte class + \x1f via Python's `\s` matching \x1c-\x1f natively; bootstrap fixed-point tag stripping; git-memory-log scope/emoji gap needs 2 constructions
