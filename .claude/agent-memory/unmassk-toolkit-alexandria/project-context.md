...
- Author: unmasSk
- License: MIT
- Current version: 1.19.4 (source of truth: unmassk-toolkit/.claude-plugin/plugin.json) — verified 2026-07-11, released (1.19.3 and 1.19.4 both shipped since the last check). [Unreleased] holds several passes since, most recently issue #72 (2026-07-18, "adelgazamiento" — anti-attacker test cut, ~9.6k lines, suite 1373→1078 passed): see changelog-state.md for the full entry breakdown.
