...
- [review-history.md](review-history.md) — Full dated log of past commit-reviews/audits with verdicts, evidence, test counts (2026-07-08 → present). Most recent: 2026-08-05 feat/memoria-v2 boot fetch-first round (remote.py/timefmt.py new), NOT MERGEABLE (`latest_activity()` misreports branch via `origin/HEAD` symref tie)
