...
- [anti-patterns.md](anti-patterns.md) — Recurring shell/Python/TS/agent-sheet-prose anti-patterns across boot/git-memory/hooks/CI-flake/self-review rounds; latest: `bin/memory/rule.py` (2026-08-25) — `--replaces` gained its sibling `--retract`'s required-`--kind` guard but not a required-new-text guard, crashes on missing positional
- [review-history.md](review-history.md) — Full dated log of past commit-reviews/audits with verdicts, evidence, test counts (2026-07-08 → present). Most recent: 2026-08-25 D-056 render lane (chain view, archivada/sustituye-a markers), LGTM — 0 issues, 1 suggestion, 1 nitpick; 1208/1210 full suite green
