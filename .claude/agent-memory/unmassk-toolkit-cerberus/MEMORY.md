...
- [anti-patterns.md](anti-patterns.md) — Recurring shell/Python/TS anti-patterns (ops-containers, unmassk-crew hooks, chatroom, session-start-boot.py module-split refactor 2026-07-05 rounds 1-14: CAMPAIGN CLOSED round 14, 109/110, MERGEABLE — monkeypatch re-target verified via live mutation test, full suite 813/9 baseline unchanged; full history of rounds 1-13 in anti-patterns.md); 2026-07-06 boot-freshness feature (issue #49): LGTM 0 blocking (5 findings); 2026-07-07 polish round: all 5 closed, LGTM, mutation-tested taskkill guard + real-boot log-write-failure test techniques, one unrelated flaky test noted
