...
[remember][user] 🧠 cuando se lanzan varios agentes de investigacion, silencio hasta el ultimo y entonces un solo informe cruzado; nunca informes sueltos segun van llegando — «Que sea la última vez que me das un informe sin haberme dado los otros. No, no, no, no. Te quedas en silencio hasta que llegas al final y, al final, me das el informe cruzado de todos.»
