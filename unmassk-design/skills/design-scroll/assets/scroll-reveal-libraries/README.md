...
- **Scripts**: Use `scripts/scroll-reveal-libraries/aos_generator.py` to generate HTML templates
- **Scripts**: Use `scripts/scroll-reveal-libraries/config_builder.py` to build custom configurations
- **References**: See `references/aos-scroll-reveal.md` (design-scroll skill root) for the condensed AOS reference
