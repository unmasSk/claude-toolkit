...
```bash
python3 ../../scripts/barba-js/project_setup.py
```

Or in CLI mode:

```bash
python3 ../../scripts/barba-js/project_setup.py --name my-project --transition fade
```
...
1. Generate project: `python3 ../../scripts/barba-js/project_setup.py --name my-site`
...
```bash
python3 ../../scripts/barba-js/transition_generator.py
```
...
- **SKILL.md** (design-scroll skill root) - Decision table and routing across all four scroll libraries
- **references/barba-js.md** - Condensed Barba.js reference (patterns, hooks, GSAP integration, transitions)
- **scripts/barba-js/transition_generator.py** - Generate custom transition code
- **scripts/barba-js/project_setup.py** - Generate complete starter projects
