...
- `../../../references/gsap-scrolltrigger.md` - Condensed GSAP ScrollTrigger reference (this skill)
- `../easings/easing_visualizer.html` - Interactive easing tool
- `../starter_scroll/` - Complete website template
- `../../../scripts/gsap-scrolltrigger/generate_animation.py` - Generate boilerplate GSAP code
- `../../../scripts/gsap-scrolltrigger/timeline_builder.py` - Interactive timeline sequence builder
...
- Check the [condensed reference](../../../references/gsap-scrolltrigger.md)
