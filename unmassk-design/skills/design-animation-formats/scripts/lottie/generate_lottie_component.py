...
# NOTE: every literal brace that must appear in the generated code (JSX/Vue/
# Svelte curly braces, not a {placeholder}) is doubled so str.format() emits
# it literally instead of treating it as a format field.
TEMPLATES = {
