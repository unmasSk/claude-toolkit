...
The `[git-memory-boot]` SessionStart hook provides ALL context pre-extracted: STATUS, BRANCH, BRANCHES, RESUME, REMEMBER, DECISIONS, MEMOS, TIMELINE, and script paths. Claude does NOT need to run doctor or git-memory-log on boot — everything is already in context.
