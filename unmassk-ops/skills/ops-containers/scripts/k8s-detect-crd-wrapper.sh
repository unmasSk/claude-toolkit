...
PYTHON_SCRIPT="$SCRIPT_DIR/k8s-detect-crd.py"
...
"$TEMP_VENV/bin/python3" -m pip install --quiet --disable-pip-version-check pyyaml >&2

# Run the script
"$TEMP_VENV/bin/python3" "$PYTHON_SCRIPT" "$YAML_FILE"
