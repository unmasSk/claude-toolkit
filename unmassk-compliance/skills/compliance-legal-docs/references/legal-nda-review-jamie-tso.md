...
Review each clause against the following categories:

**Key clauses**: Definition of Confidential Information (scope, carve-outs), Permitted Use (purpose limitation), Permitted Disclosure (need-to-know, authorized recipients), Return/Destruction obligations.

**Party obligations**: Recipient's duty of care (reasonable measures vs. same-as-own), notification of unauthorized disclosure, obligation to assist in enforcement, non-solicitation of personnel (if included).

**Duration & scope**: Term of the agreement, survival period for confidentiality obligations after expiration, territorial scope, governing law and jurisdiction.

**Remedies & liability**: Injunctive relief clause, indemnification obligations, liability caps (if any — unusual in NDAs but sometimes included), consequential damages waiver.

**Standard exceptions**: Publicly available information, independently developed information, received from a third party without restriction, required by law/court order (with notice obligation).
